...
<html>
    ...
    <body background="imagenes/FondoPres.jpg">
        ...
        <div class="row" style="margin-left: 11%">
            ...
            <div class="flex-column col-12 col-sm-12 col-md-4 col-lg-4 col-xl-6"></div>
            <div class="flex-column col-12 col-sm-12 col-md-4 col-lg-4 col-xl-3">
                <div class="m-auto">
                    <div class="container-fluid">
                        <a href="">
            ...
            <div class="flex-column col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="m-auto">
                    <div class="container-fluid">
                        <a href="">
                            <div class="card">
