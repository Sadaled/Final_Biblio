                        ...
                        <form name="form-sancion" method="post" action="procesa_sancion">
                            ...
                            <div class="form-row">
                                <div class="col-md-10 mb-3">
                                  <label>Lector</label>
                                  <<select>
                                        <option value="<%=CodLector%>"><%=listaLector.get(ul).getNomLector()%></option>
                                        <%for(int i=0;i<listaLector.size();i++){%>
                                            <%if(i!=ul){%>
                                                <option value="<%=CodLector%>"><%=listaLector.get(i).getNomLector()%></option>
                                            <%}%>
                                        <%}%>
                                    </select>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select>
                                        <option value="<%=Cod_Sanc%>"><%=listaTipo_sancion.get(uts).getDes_Sanc()%></option>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select>
                                        <option value="<%=Cod_Sanc%>"><%=listaEncargado.get(ue).getCodEncargado()%></option>
                                        <%for(int i=0;i<listaEncargado.size();i++){%>
                                            <%if(i!=ue){%>
                                                <option value="<%=listaTipo_sancion.get(i).getCod_Sanc()%>"><%=listaEncargado.get(i).getCodEncargado()%></option>
                                            <%}%>
                                        <%}%>
                                    </select>
                                </div>
